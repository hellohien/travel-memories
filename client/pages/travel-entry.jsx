...
class TravelEntry extends React.Component {
  render() {
    ...
    const dateValue = this.props.date;
    const favoriteMomentsValue = this.props.favoriteMoments;
    return (
      <form id="form" onSubmit={onSubmit}>
        ...
        <div className="row column-full">
          ...
          <input value={dateValue} onChange={handleChange} id="date" type="date" name="date" required></input>
        </div>
        <div className="row column-full">
          <label htmlFor="favoriteMoments">Favorite moments:</label>
          <input value={favoriteMomentsValue} onChange={handleChange} id="favoriteMoments" type="text" name="favoriteMoments" maxLength="65"></input>
        </div>
